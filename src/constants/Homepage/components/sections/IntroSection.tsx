      ...
      <section className="flex flex-col items-center justify-center max-w-[600px] mx-auto w-full gap-25 mt-25">
        <div className="flex w-full flex-col items-start justify-center gap-5 p-10 bg-[#FFE150] border-2 border-white">
          <span className="text-tk-black desktop-s6-th-400">
            หน่วยงานที่ต้องการออกแบบและสร้างพื้นที่การเรียนรู้ที่มีชีวิต
            ในจังหวัดของตนเอง
            สามารถใช้คู่มือนี้เป็นแนวทางในการสร้างสรรค์พื้นที่การ
            เรียนรู้สำหรับคนทุกเพศทุกวัย โดยเฉพาะเด็กและเยาวชน
            ให้พวกเขาได้เข้ามา เรียนรู้ เล่นสนุก และทดลองนวัตกรรมใหม่ๆ โดยมี TK
            Park ซึ่งเป็นองค์กรที่มี
            ประสบการณ์ในการพัฒนาพื้นที่เรียนรู้เป็นพันธมิตรในการออกแบบ
          </span>
        </div>
        ...
        <div className="relative flex w-full flex-col items-start">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-2.5 border-x-2 border-b-2 border-white bg-[#FEDFCA] p-10 text-white ">
            <h2 className="font-th desktop-s6-th-400 text-tk-black text-start mt-[114px]">
              ...
              เข้าถึงได้
              และเชื่อมั่นว่าการสร้างพื้นที่การเรียนรู้หรือระบบนิเวศที่ดีจะสามารถ
              สนับสนุนให้ผู้ใช้บริการเห็นภาพว่า
              ตัวเองจะส่งต่อความสร้างสรรค์ต่อสังคม ได้อย่างไร
              โดยเฉพาะเด็กและเยาวชนรุ่นใหม่ ผู้ต้องเติบโตไปพร้อมๆ กับโลก
              ดิจิทัลไร้พรมแดน
            </h2>
          </div>
        </div>
        <div className="flex w-full flex-col items-start justify-center gap-5 p-10 bg-[#FEE6A6] border-2 border-white">
          <span className="text-tk-black desktop-s6-th-400">
            ...
            สามารถเกิดขึ้นได้ในที่เดียวกันทั่วภูมิภาคในประเทศ
            ไทยโดยสามารถศึกษาแนวทางในการออกแบบพื้นที่การเรียนรู้ เพื่อประเมิน
            ความพร้อมในด้านพื้นที่ การบริการ และวิธีการบริหารจัดการทรัพยากรของ
            ชุมชนตนเอง รวมถึงสำรวจกิจกรรมและตัวอย่างของพื้นที่การเรียนรู้ที่ดี
            ได้ที่เว็บไซต์แห่งนี้
          </span>
