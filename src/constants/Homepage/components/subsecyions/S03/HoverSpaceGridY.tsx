  ...
  return (
    <>
      ...
      >
          ...
          <HoverCell
            ...
            tips={[
              ...
              <>
                ที่นั่งอ่าน:
                <br />
                ควรมีหลายรูปแบบ เช่น เก้าอี้ โซฟา บีนแบ็ก เก้าอี้เลาจน์
              </>,
            ]}
        ...
        <SpaceRow bordered>
          <HoverCell
            title="การควบคุมเสียงในพื้นที่อ่าน"
            tips={[
              "จัดระดับเสียงให้เหมาะสมกับพื้นที่ที่ต้องใช้สมาธิโดยเลือก ใช้วัสดุที่ลดเสียงสะท้อนและ ดูดซับเสียง เช่น การใช้พรม วัสดุซับเสียงหรือผนังที่ออกแบบมาเพื่อลดเสียงโดยเฉพาะ",
              <>
                ควรจัดผังพื้นที่ให้ชัดเจน
                <br />
                ดูแยกโซนสำหรับการใช้งานที่ต้องการความเงียบออกจาก
                <br />
                โซนกิจกรรมหรือพื้นที่ที่มีการ เคลื่อนไหวและพูดคุย
              </>,
            ]}
            className="col-span-6 md:col-span-3 border-b-2 md:border-b-0 md:border-r-2 border-white"
            icon={<ColFiveIcon />}
          ...
          <HoverCell
            ...
            tips={[
              "พื้นที่การเรียนรู้ที่ดีและมีศักยภาพต้องออกแบบให้ทุกคนสามารถเข้าถึงและใช้งานได้อย่างเท่าเทียมโดยต้องใส่ใจในรายละเอียดเพื่อลดอุปสรรคในการใช้งาน",
              "ทางลาดเพื่อรองรับผู้ใช้รถเข็น",
              "จัดทางเดินให้กว้างเพียงพอ ไม่น้อยกว่า 120 ซม.",
        ...
        <SpaceRow bordered>
          <HoverCell
            ...
            tips={[
              ...
              "จัดนิทรรศการ งานออกแบบ งานสร้างสรรค์เพื่อเติมเต็มองค์ประกอบทางศิลปะ",
            ]}
