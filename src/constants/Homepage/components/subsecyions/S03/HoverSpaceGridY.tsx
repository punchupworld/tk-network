      ...
      >
        ...
        <SpaceRow bordered>
          <HoverCell
            ...
            tips={[
              <>
                จัดระดับเสียงให้เหมาะสมกับพื้นที่
                <br className="sm:hidden block" />
                ที่ต้องใช้สมาธิโดยเลือก
                <br className="hidden sm:block" />
                ใช้วัสดุ
                <br className="sm:hidden block" />
                ที่ลดเสียงสะท้อนและ
                <br className="hidden sm:block" />
                ดูดซับเสียง <br className="sm:hidden block" />
                เช่น การใช้พรม วัสดุซับเสียงหรือ
                <br className="sm:hidden block" />
                ผนังที่ออกแบบมาเพื่อลดเสียง
                <br />
                โดยเฉพาะ
              </>,
              <>
                ...
                <br />
                แยกโซนสำหรับการใช้งาน
                <br className="sm:hidden block" />
                ที่ต้องการความเงียบออกจาก
                <br />
          ...
          <HoverCell
            ...
            tips={[
              <>
                ...
                เข้าถึงและ
                <br className="hidden sm:block" />
                ใช้งานได้อย่างเท่าเทียม
                <br className="sm:hidden block" />
                โดยต้องใส่ใจในรายละเอียด
                <br className="sm:hidden block" />
                เพื่อลดอุปสรรคในการใช้งาน
              </>,
