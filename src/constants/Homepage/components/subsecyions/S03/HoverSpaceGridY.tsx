      ...
      >
        <SpaceRow>
          ...
          <HoverCell
            ...
            tips={[
              "โต๊ะอ่านหนังสือ กว้าง 120-150 ซม. ลึก 60-75 ซม. สูง 75 ซม.",
              "โต๊ะทำงานกลุ่ม: กว้าง 180-240 ซม. รองรับ 6-8 คน",
        ...
        <SpaceRow bordered>
          ...
          <HoverCell
            ...
            tips={[
              "พื้นที่การเรียนรู้ที่ดีและ มีศักยภาพต้องออกแบบให้ทุกคนสามารถเข้าถึงและใช้งานได้ อย่างเท่าเทียมโดยต้องใส่ใจใน รายละเอียดเพื่อลดอุปสรรคใน การใช้งาน",
