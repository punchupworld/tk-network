    ...
    <div className="flex w-full max-w-[730px] flex-col items-center justify-center gap-50">
      ...
      <div className="@container relative w-full">
        ...
        >
          ...
          >
            <p>
              หน่วยงานสามารถออกแบบให้พื้นที่เป็นห้องปิด
              <br className="sm:hidden block" />
              สำหรับ
              {/* <br /> */}
              ทำกิจกรรมกลุ่มส่วนตัว และเป็นสัดส่วน
              <br className="sm:hidden block" />
              อย่างชัดเจน {/* <br /> */}
              ผู้ใช้บริการจึงสามารถใช้งานได้โดย
              <br className="sm:hidden block" />
              ไม่รบกวน
              <br className="hidden sm:block" />
              ...
              {/* <br /> */} (เนื่องจากมีการ
              <br className="sm:hidden block" />
              ใช้งานร่วมกับพื้นที่อื่นค่อนข้างน้อย) {/* <br /> */}
              และออกแบบให้
              <br className="sm:hidden block" />
              มีความยืดหยุ่นต่อการใช้งานสำหรับกิจกรรมต่างๆ{" "}
              <br className="sm:hidden block" />
          ...
          >
            <p>
              ...
              <br className="sm:hidden block" />
              ส่วนใหญ่แล้วกิจกรรม ในพื้นที่นี้เป็นกิจกรรมที่ต้องใช้
              <br className="sm:hidden block" />
              สมาธิ มีระยะเวลานานและต่อเนื่อง
              <br className="hidden sm:block" />
              หน่วยงานสามารถ
              <br className="sm:hidden block" />
              ออกแบบให้พื้นที่อยู่ห่างจากเส้นทางสัญจรหลัก{" "}
              <br className="sm:hidden block" />
              หรือพื้นที่กิจกรรมที่ส่งเสียงรบกวน ควรใช้ผัง
              <br className="sm:hidden block" />
              แบบเปิด (Opened Plan) ซึ่งเป็นพื้นที่ในลักษณะ
              <br className="sm:hidden block" />
              เปิดโล่ง ไม่มีผนังทั่วทั้งพื้นที่ หากมีพื้นที่ค่อนข้างใหญ่
              <br className="sm:hidden block" />
              ควรแบ่งเป็นพื้นที่ย่อยเพื่อความสะดวกในการใช้งาน
              <br className="sm:hidden block" />
              และบริหารจัดการ
            </p>
          </SpaceTypeBlock>
          ...
          >
            <p>
              พื้นที่นี้รับรองการใช้งานที่หลากหลายจากผู้ใช้บริการ
              <br className="sm:hidden block" />
              ทุกกลุ่ม ดังนั้น
              <br className="hidden sm:block" />
              การจัดพื้นที่ควรเป็นพื้นที่ย่อยหลาย
              <br className="sm:hidden block" />
              รูปแบบ เช่น จัดมุมหนังสือ มุมเด็กเล็ก{" "}
              <br className="hidden sm:block" />
              มุมพูดคุย
              <br className="sm:hidden block" />
              ผ่อนคลาย และเข้าถึงง่ายทั้งจากภายนอก และ
              <br className="sm:hidden block" />
              พื้นที่อื่น {/* <br /> */}
              บรรยากาศโดยรวมควรมีความคึกคัก
              <br className="sm:hidden block" />
              และมีชีวิตชีวา {/* <br /> */}
              เห็นการเรียนรู้ที่หลากหลาย และ
              <br />
              ความเคลื่อนไหวของ
              {/* <br /> */}
              ผู้ใช้บริการ ไม่ว่าจะเป็น
              <br className="sm:hidden block" />
              กลุ่มครอบครัว เด็กเล็ก <br className="hidden sm:block" />
              หรือผู้สูงอายุ
            </p>
          </SpaceTypeBlock>
          ...
          >
            <p>
              ...
              สร้างความรู้สึก
              <br className="hidden sm:block" />
              เป็นกันเองให้ผู้ใช้บริการ อยู่ใน
              <br className="sm:hidden block" />
              ตำแหน่งที่เข้าถึงง่ายจาก
              {/* <br /> */}
              ภายนอก โดยให้พื้นที่
              <br className="sm:hidden block" />
              บางส่วนอยู่บริเวณ
              {/* <br /> */}
              กึ่งภายนอกอาคาร ผู้ใช้บริการ
              <br className="sm:hidden block" />
              ที่ไม่ได้เป็นสมาชิกของ
              <br className="hidden sm:block" />
              ห้องสมุด อาจเข้ามาใช้บริการ
              <br className="sm:hidden block" />
              บางส่วนได้
            </p>
          </SpaceTypeBlock>
            ...
            >
              ...
              <div className="flex min-h-0 flex-1 flex-col gap-2.5 overflow-y-auto font-th desktop-s7-th-400 text-white">
                <p className="font-th desktop-s7-th-400">
                  ...
                  ได้เป็นพื้นที่สำนักงานต้อนรับและพื้นที่บริหาร
                </p>
                <p>
                  ...
                  <br className="sm:hidden block" />
                  กับพันธมิตรและผู้สนใจทำกิจกรรมในพื้นที่{" "}
                  <br className="sm:hidden block" />
                ...
                <p>
                  ...
                  <br className="sm:hidden block" />{" "}
                  โดยอาจแยกเส้นทางออกมาเพื่อประสิทธิภาพ
                  <br className="sm:hidden block" />
                ...
                <p>
                  ...
                  <br className="sm:hidden block" />
                  และพื้นที่นั่งทำงานด้วย เช่น อุปกรณ์เวที <br />
