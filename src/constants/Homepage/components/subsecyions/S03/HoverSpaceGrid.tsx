      ...
      >
        ...
        <SpaceRow bordered>
          ...
          <HoverCell
            ...
            description={
              <>
                พื้นที่ที่มีทั้งหนังสือ แท็ปเล็ต ห้องสมุดดนตรี TK และเครื่อง
                ดนตรีให้ลองสัมผัส
                <br />
                ผู้ใช้งาน สามารถค้นคว้าข้อมูลเกี่ยวกับ ดนตรีจากทุกมุมโลก
                และที่สำคัญคือสามารถ ร้อง เล่น ฟัง ในพื้นที่นี้ได้
              </>
            }
            image={BOX_IMAGE_6}
            tips={[
