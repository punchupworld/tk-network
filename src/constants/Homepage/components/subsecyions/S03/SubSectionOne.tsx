    ...
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-50">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-5 p-10 border-2 border-white bg-[#FEE6A6]">
        <p className="font-th desktop-s6-th-400 text-tk-black">
          การพัฒนาพื้นที่การเรียนรู้อย่างยั่งยืน
          จำเป็นต้องผสานการออกแบบพื้นที่ที่ยืดหยุ่นและหลากหลาย
          เครือข่ายต้องเข้าใจผู้ใช้อย่างถ่องแท้
          และจัดระบบการบริหารที่มีประสิทธิภาพ
      ...
      <div className="flex items-start md:flex-row flex-col" id="subsubtopic8">
        ...
        <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-2.5">
          ...
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
            ตลอดระยะเวลาที่ผ่านมา TK Park
            ร่วมงานกับทั้งหน่วยงานรัฐและองค์กรไม่แสวงผลกำไร
            ตั้งแต่องค์การบริหารส่วนจังหวัด องค์การบริหารส่วนตำบล เทศบาลตำบล
            เมือง นคร กระทรวง กรม หน่วยงานด้านการศึกษา มูลนิธิ สหกรณ์ และสมาคม
          </p>
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
        ...
        <div className="flex w-full flex-col items-start gap-10 border-x-2 border-white bg-[#91C5F4] px-10 pt-5 pb-10 text-white">
          ...
          <div className="grid w-full grid-cols-1 md:grid-cols-2">
            <div className="flex flex-col">
              ...
              <p className="border-x border-t border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black">
                เดินทางสะดวก รองรับทั้งรถส่วนตัวและสาธารณะ
              </p>
              <p className="border-x border-t border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black">
                อยู่ใกล้ระบบขนส่งสาธารณะและ พื้นที่การเรียนรู้อื่นๆ
                เดินด้วยเท้าไม่เกิน 400-500 เมตรจากจุดจอดรถ
              </p>
            ...
            <div className="flex flex-col justify-end">
              ...
              <p className="border-x border-t md:border-l-0 border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black">
                หากอยู่ในอาคารหลายชั้น ควรตั้งอยู่ชั้นล่างสุด
              </p>
              <p className="border-x border-t md:border-l-0 border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black">
                มีพื้นที่สำหรับทำกิจกรรมทั้งภายในและภายนอก
              </p>
              <p className="border-x border-t border-b md:border-l-0 border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black">
                มีศักยภาพในการขยายพื้นที่ใน ระยะยาว
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-10">
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-2.5">
            <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
              หนังสือและสื่อที่หลากหลาย ทำให้เกิดการเรียนรู้
              ที่หลายหลากตามความสนใจของผู้ใช้บริการ
              เนื่องจากหนังสือและสื่อเป็นตัวกลางสำคัญ
              ที่หน่วยงานสามารถจัดหมวดหมู่เพื่อสร้าง การเรียนรู้โดยไม่ตั้งใจ
              และสอดแทรกไปกับการ ทำกิจกรรมรูปแบบต่างๆ ได้
            </p>
          </div>
        </div>
            ...
            <div className="grid w-full grid-cols-1 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-end">
                <p className="border-x border-t  border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black bg-white">
                  คำนึงถึงความสนใจของกลุ่มผู้ใช้งาน และสภาพแวดล้อมเป็นหลัก
                </p>
                <p className="border-x border-t  border-tk-black px-[14px] py-[10px] font-th desktop-s6-th-400 text-tk-black bg-white">
      ...
      <div className="flex md:flex-row flex-col items-start">
        ...
        <div className="p-10 border-2 border-white bg-orange-50 flex flex-col gap-2.5">
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
            ...
            โดยหน่วยงานต้องวางแผนเรื่องการจัดสรรงบประมาณอย่างเหมาะสม
            เพราะนอกจากงบประมาณด้านการก่อสร้าง
            พื้นที่การเรียนรู้ซึ่งเป็นงบประมาณหลัก
            ยังต้องคำนึงถึงงบประมาณดำเนินการ ในแต่ละปีด้วย
          </p>
        </div>
      </div>
