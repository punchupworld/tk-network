    ...
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-50">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-5 p-10 border-2 border-white bg-[#FEE6A6]">
        <p className="font-th desktop-s6-th-400 text-tk-black">
          ทุกอย่างต้องเริ่มจาก “ความพร้อมของเครือข่าย”
          เนื่องจากความแตกต่างในบริบททางกายภาพและการบริหารจัดการของหน่วย
          งานเจ้าภาพ
          ดังนั้นการหารือร่วมกันจึงเป็นกระบวนการสำคัญที่จะทำให้หน่วยงานในฐานะ
          เครือข่าย TK Park เข้าใจและต่อยอดได้ว่า
          การสร้างพื้นที่การเรียนรู้ที่เป็นหัวใจของชุมชนต้องการอะไร
          ต้องดำเนินการอย่างไรบ้าง โดยตัวอย่างด้านล่างเหล่านี้คือเครื่องมือ
      ...
      <div className="flex items-start h-full flex-col md:flex-row">
        ...
        >
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
            โมเดลพื้นที่การเรียนรู้พร้อมใช้งาน
            ไม่ว่าจะเป็นโมเดลด้านการออกแบบพื้นที่ การบริการ การบริหารจัดการ
          </p>
        </div>
      </div>
      <div className="flex items-start flex-col md:flex-row">
        ...
        <div className="p-10 border-2 border-white bg-orange-50 flex flex-col gap-2.5">
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
            ...
            ทั่วประเทศ เพื่อให้หน่วยงานสามารถนำไปประยุกต์ใช้ได้
            อย่างเหมาะสมกับบริบทของตนเอง ทั้งกิจกรรมส่งเสริมการอ่าน
            การเรียนรู้เชิงสร้างสรรค์ เวิร์กช็อป การเรียนรู้ผ่านการเล่น
            ตลอดจนกิจกรรมที่ช่วยสร้างการมีส่วนร่วม ของคนในชุมชน
            โดยสามารถเลือกปรับรูปแบบ ระยะเวลา
            และกลุ่มเป้าหมายให้สอดคล้องกับศักยภาพ ของพื้นที่ได้
          </p>
        </div>
      </div>
      <div className="flex items-start flex-col md:flex-row">
        ...
        <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-2.5">
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
            ระบบและเครื่องมือเพื่อช่วยให้การทำงาน สะดวกสบายขึ้น
          </p>
        </div>
      </div>
      <div className="flex w-full flex-col items-start" id="subsubtopic7">
        ...
        <div className="flex w-full flex-col items-start gap-10 border-x-2 border-white bg-[#F5333F] px-10 pt-5 pb-10 text-white">
          ...
          <div className="flex items-start">
            ...
            <div className="bg-white border border-yellow-700">
              <div className="px-[14px] py-2.5 font-th desktop-s6-th-400 text-tk-red">
                ...
                ได้อย่างสะดวกสบายผ่านสมาร์ตโฟน ไม่ว่าจะเป็นการค้นหา
                การจองหนังสือ การสมัครเข้าร่วมกิจกรรม
                โดยสามารถใช้บัตรสมาชิกดิจิทัล (QR Code) ตรวจสอบข้อมูลสมาชิก
          ...
          <div className="flex items-start">
            ...
            <div className="bg-white border border-yellow-700">
              <div className="px-[14px] py-2.5 font-th desktop-s6-th-400 text-tk-red">
                แอพพลิเคชันห้องสมุดดิจิทัลของ TK Park ที่รวบรวมอีบุ๊ก
                อีแม็กกาซีน หนังสือเสียง หรือแม้กระทั่งคอร์สออนไลน์ไว้ในที่เดียว
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-start flex-col md:flex-row">
        ...
        <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-2.5">
          <p className="font-th desktop-s6-th-400 text-tk-black text-balance">
            จัดอบรมกระบวนการพัฒนาศักยภาพบุคลากรผ่านการฝึกปฏิบัติงาน (On-the-Job
            Training) ก่อนเปิดบริการเกี่ยวกับการทำงานหลังบ้าน ที่ครอบคลุมทุกด้าน
          </p>
        </div>
      </div>
        ...
        <div className="flex w-full flex-col items-center justify-center gap-10 border-x-2 border-b-2 border-white bg-[#FEDFCA] px-10 pb-10">
          <div className="flex items-start">
            ...
            <div className="px-[14px] py-2.5 border border-tk-black">
              <p className="font-th desktop-s6-th-400 text-tk-black">
                อบรมความรู้ด้านบรรณารักษ์และการบริหารจัดการห้องสมุด
          ...
          <div className="flex items-start">
            ...
            <div className="px-[14px] py-2.5 border border-tk-black">
              <p className="font-th desktop-s6-th-400 text-tk-black">
                อบรมกิจกรรมส่งเสริมการเรียนรู้และแนวทางการจัด กิจกรรม
                เสริมสร้างความรู้และทักษะในการออกแบบและดำเนิน
          ...
          <div className="flex items-start">
            ...
            <div className="px-[14px] py-2.5 border border-tk-black">
              <p className="font-th desktop-s6-th-400 text-tk-black">
                ...
                การจัดทำสื่อประชาสัมพันธ์ การใช้งานตราสัญลักษณ์ สี
                รูปแบบตัวอักษร และองค์ประกอบการสื่อสารต่าง ๆ
              </p>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div className="px-[14px] py-2.5 border border-tk-black">
              <p className="font-th desktop-s6-th-400 text-tk-black">
                ...
                เรียนรู้การปฏิบัติงานจริงจากอุทยานการเรียนรู้ TK Park ชั้น 8
                ศูนย์การค้าเซ็นทรัลเวิลด์ ซึ่งเป็นพื้นที่ต้นแบบ
                โดยสังเกตการณ์และฝึกปฏิบัติงานภายใต้การดูแลของเจ้า
                หน้าที่ผู้มีประสบการณ์เพื่อให้บริการผู้ใช้งานได้อย่างตรงจุด
                รวมถึงการบริหารจัดการพื้นที่การเรียนรู้ และปัญหาเฉพาะหน้าต่างๆ
              </p>
            </div>
          </div>
        </div>
