    ...
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-25">
      ...
      >
        ...
        <p className="text-tk-black desktop-s6-th-400">
          ...
          ไปสู่การขยายบทบาทในการ “สร้างระบบนิเวศการเรียนรู้”
          ให้เกิดขึ้นทั่วประเทศ
        </p>
        <p className="text-tk-black desktop-s6-th-400">
          ภาพจำของห้องสมุดแบบดั้งเดิมคือการเป็นแหล่งเก็บหนังสือและให้บริการยืม-คืนหนังสือ
          แต่ในยุคปัจจุบันห้องสมุดควรพัฒนาบริการที่ผสมผสานการเรียนรู้เข้าไปในพื้นที่สาธารณะทั้งในรูปแบบออฟไลน์และออนไลน์
        ...
        <p className="text-tk-black desktop-s6-th-400">
          ...
          ห้องสมุดภายใต้การบริหารจัดการของเครือข่ายในหลายพื้นที่มีความโปร่งโล่ง
          นุ่มสบาย มีหมอนและโซฟาไว้สำหรับนั่งเล่น
        ...
        <p className="text-tk-black desktop-s6-th-400">
          การออกแบบที่หลากหลายและฟังก์ชันการใช้งานที่เพิ่มขึ้นมาบ่งบอกถึงการให้
          ความสำคัญกับผู้ใช้งานเป็นหลัก ดังนั้นของบางอย่าง
          แค่มีอยู่อย่างเดียวจึงไม่เพียงพอ เช่น เราอาจมีหนังสือล้นห้องสมุด
          แต่ไม่มีระบบหรือกิจกรรมที่ส่งเสริมให้เกิดการเรียนรู้ตลอดชีวิต
