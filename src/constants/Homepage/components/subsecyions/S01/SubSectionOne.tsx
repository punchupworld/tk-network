...
const SubSectionOne = () => {
  return (
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-25">
      ...
      <div
        className="flex w-full flex-col gap-5 p-10 bg-[#FEE6A6] border-2 border-white"
        id="subsubtopic1"
      >
        <p className="text-tk-black desktop-s6-th-400">
          เมื่อหน่วยงานสนใจที่จะสร้างพื้นที่การเรียนรู้ร่วมกันกับ TK Park <br />
          นี่คือ ภาพคร่าวๆ ของกระบวนการเบื้องต้น
        </p>
        <p className="text-tk-black desktop-s6-th-400 ">
          เครือข่ายอาจเริ่มทำงานโดยการศึกษาเป้าหมายก่อนเป็นอันดับแรก
          <br />
          เมื่อเราเข้าใจกลุ่มเป้าหมายและพื้นที่
          ก็จะเข้าสู่กระบวนการคิดเชิงออกแบบ <br />
          เช่น การบริการต้องเป็นแบบไหน พื้นที่มีขนาดเท่าไหร่
          <br />
          ลักษณะใดจึงจะตอบโจทย์ แล้วโปรแกรมกิจกรรมล่ะ จะออกแบบอย่างไรดี <br />
          ให้สอดคล้องกับบริบทของพื้นที่และกลุ่มเป้าหมายหลัก
        ...
        <p className="text-tk-black desktop-s6-th-400">
          ...
          เพราะพื้นที่การเรียนรู้ที่ดีไม่ได้มีรูปแบบตายตัว <br /> แต่คือพื้นที่
          ...
          <div className="grid w-full grid-cols-1 border border-tk-black text-tk-black sm:grid-cols-2">
            <div className="flex flex-col">
              <p className="border-b border-tk-black p-5 font-th desktop-s6-th-400 leading-normal last:border-b-0">
                หน่วยงานมีความเข้าใจในการออกแบบและพัฒนาพื้นที่ <br />
                การเรียนรู้ให้เหมาะสมกับบริบทและความต้องการของพื้นที่
              </p>
              <p className="border-b border-tk-black p-5 font-th desktop-s6-th-400 leading-normal last:border-b-0">
                ยกระดับสร้างอนาคตของคน
                <br />
                ในพื้นที่ให้เข้าถึงการเรียนรู้
                <br />
                ที่ออกแบบมาให้สอดคล้อง
                <br />
            ...
            <div className="flex flex-col border-t border-tk-black sm:border-l sm:border-t-0">
              ...
              <p className="border-b border-tk-black p-5 font-th desktop-s6-th-400 leading-normal">
                ชุมชนมีชีวิตชีวาเพราะมีพื้นที่การเรียนรู้เชิงสร้างสรรค์
                <br />
                ของตัวเอง
              </p>
              <p className="border-b border-tk-black p-5 font-th desktop-s6-th-400 leading-normal">
                พัฒนาจากห้องสมุด
                <br /> ในความหมายเดิม สู่ศูนย์กลางการเรียนรู้ของชุมชน
              </p>
              <p className="p-5 font-th desktop-s6-th-400 leading-normal">
                เชื่อมโยงความรู้ เทคโนโลยี
                <br /> และวิถีชีวิตเข้าด้วยกัน
              </p>
            </div>
          </div>
        </div>
