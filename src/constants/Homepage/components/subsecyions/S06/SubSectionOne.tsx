    ...
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-50">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-5 p-10 border-2 border-white bg-[#FEE6A6]">
        ...
        <p className="font-th desktop-s6-th-400 text-tk-black">
          ...
          พบว่าผู้ใช้บริการทุกเพศทุกวัยที่เข้ามาใช้พื้นที่การเรียนรู้ในแต่ละช่วงเวลาของวันและสัปดาห์มีความแตกต่างกันอย่างมีนัยยะสำคัญ
        ...
        <div className="flex items-start md:flex-row flex-col ">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              ปีนป่ายในพื้นที่ที่ถูกออกแบบไว้
      ...
      >
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              ทำรายงาน พักผ่อน
              หรือใช้คอมพิวเตอร์เพื่อทำงานหรือรอผู้ปกครองมารับในช่วงเวลาหลังเลิกเรียน
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex w-full flex-col border-2 border-white bg-yellow-100 px-10 pt-5 pb-10">
            ...
            <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border border-[#D9D9D9]">
              <b>ศูนย์วิทยาศาสตร์พื้นฐาน อุทยานการเรียนรู้ปัตตานี</b> เด็กๆ
      ...
      >
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              กลุ่มนี้มีความต้องการในการใช้งานที่หลากหลาย
              ไม่ว่าจะเป็นการอ่านหนังสือวิชาการ ทำรายงาน
              ...
              ตั้งแต่ระดับที่เงียบสงบไปจนถึงพื้นที่ที่อนุญาตให้ใช้เสียงได้เต็มที่
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              ซึ่งโดยมากแล้วจะมาแช่ตัวอยู่ในพื้นที่ค่อนข้างนานและต่อเนื่อง
            ...
            <div className="flex md:flex-row flex-col">
              ...
              <div className="flex-1">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-y border-r border-[#D9D9D9]">
                  ...
                  เพราะที่นี่มีนิคมอุตสาหกรรมและพนักงานจำนวนมาก ซึ่งทำงานเป็นกะ
                  ดังนั้นจึงไม่สะดวกที่จะเดินทางเข้าห้องสมุดในเวลาทำการ
        ...
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              พวกเขามักจะมาใช้บริการในช่วงสายจนถึงเที่ยงในช่วงวันธรรมดาและวันหยุด
          ...
          <div className="flex w-full flex-col border-2 border-white bg-yellow-100 px-10 pt-5 pb-10">
            <div className="flex md:flex-row flex-col">
              ...
              <div className="flex-1">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-y border-r border-[#D9D9D9]">
                  กิจกรรมส่งเสริมการเรียนรู้ของผู้สูงอายุ ศูนย์การเรียนรู้
                  ฉะเชิงเทรา ผู้สูงวัยจะได้ทั้งเรียนรู้และเสริมสุขภาพ เช่น
