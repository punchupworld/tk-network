    ...
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-50">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-5 p-10 border-2 border-white bg-[#FEE6A6]">
        <p className="font-th desktop-s6-th-400 text-tk-black">
          ...
          หรือจะมีเสียงดนตรีคลอให้รู้สึกผ่อนคลาย
        </p>
        <p className="font-th desktop-s6-th-400 text-tk-black">
          เมื่อเปิดประตูแหล่งเรียนรู้ กลุ่มผู้ปกครองอาจจะอยากนั่งรอลูก บรรดาแม่ๆ
          ได้โอกาสคุยกันระหว่างที่ลูกกำลังใช้พื้นที่
          กลุ่มเด็กเล็กอยากเข้ากิจกรรมเล่านิทานเด็ก
          กลุ่มนักเรียนนักศึกษาอาจจะอยากใช้ห้องประชุมทำงาน
          คุยเล่นเรื่องซีรียส์ดัง อ่านไปงีบไป ติวหนังสือสอบ
          กลุ่มผู้ใหญ่และผู้สูงอายุอาจจะอยากคุยเข้มสภากาแฟ หรือออกกำลังกาย
        </p>
        <p className="font-th desktop-s6-th-400 text-tk-black">
          การศึกษาข้อมูลภาคสนามของ TK Park
          พบว่าผู้ใช้บริการทุกเพศทุกวัยที่เข้ามาใช้พื้นที่การเรียนรู้ในแต่ละช่วงเวลา
          ของวันและสัปดาห์มีความแตกต่างกันอย่างมีนัยยะสำคัญ
          ...
          ซ้อมการแสดง ผู้ปกครองและเด็กเล็กอ่านหนังสือนิทาน
          ส่วนวัยทำงานอาจนั่งทำงานกับโน้ตบุ้คสักตัว
        </p>
        <p className="font-th desktop-s6-th-400 text-tk-black">
          ...
          นักศึกษาเข้ามาใช้งานมากเป็นพิเศษ
      ...
      >
        <div className="flex items-start md:flex-row flex-col ">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              ปีนป่ายในพื้นที่ถูกออกแบบไว้
              พ่อแม่อาจจะร่วมทำกิจกรรมด้วยหรืออ่านหนังสือ เล่นโทรศัพท์อยู่ใกล้ๆ
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start">
          <div className="relative z-10 mb-[-2px] w-fit border-x-2 border-t-2 border-white bg-yellow-100 p-10">
            <p className="font-th desktop-s6-th-400 text-white py-1 px-2.5 bg-tk-red w-fit">
              กิจกรรมต้นแบบ
            </p>
          ...
          <div className="flex w-full flex-col border-2 border-white bg-yellow-100 px-10 py-5">
            ...
            <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-x border-t border-[#D9D9D9]">
              ...
              เล่มที่คัดสรรโดยบรรณารักษ์ของห้องสมุดเด็ก TK Park
              และของเล่นไม้เสริมทักษะ 1 ชุดจากบริษัทแปลนทอยส์
            </p>
            <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border border-[#D9D9D9]">
              ...
              และชุดของเล่นที่ประกอบด้วยฐานพร้อมเสา 4 ต้น พุ่มไม้ 10 พุ่ม
              เพื่อฝึกนับเลขและจำแนกสีผ่านต้นไม้ในฤดูกาลต่างๆ
              และช่วยเสริมสร้างกล้ามเนื้อมัดเล็ก ความสัมพันธ์ของมือและสายตา
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              พวกเขามักจะพากันมาใช้พื้นที่ห้องสมุดแบบ เป็นแก๊งเพื่ออ่านหนังสือ
              ทำรายงาน พักผ่อน หรือใช้คอมพิวเตอร์เพื่อทำงานหรือรอ
              ผู้ปกครองมารับในช่วงเวลาหลังเลิกเรียน
              หรือวันหยุดโดยไม่ต้องเสียค่าใช้จ่ายเพิ่มเติม
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex w-full flex-col border-2 border-white bg-yellow-100 px-10 py-5">
            ...
            <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-x border-t border-[#D9D9D9]">
              สร้างฝันสร้างคิดส์ อุทยานการเรียนรู้แม่ฮ่องสอน
              จังหวัดแม่ฮ่องสอนมีชาวชาติพันธุ์หลายกลุ่มอาศัยอยู่
              อุทยานจึงจัดกิจกรรมน่ารู้ด้านภาษา เช่น ภาษาไทใหญ่ ภาษากะเหรี่ยง
              เด็กๆ
              จะได้เรียนรู้ว่าจังหวัดของตัวเองมีความหลากหลายทางภาษาและเรียนรู้
              มนุษย์ไปด้วย
            </p>
            <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-x border-t border-[#D9D9D9]">
              มุมบันไดนักอ่าน อุทยานการเรียนรู้เมืองนครราชสีมา
              หนังสือและนิยายจำนวนมากทำให้มุมนี้กลายเป็นมุมยอดฮิตของกลุ่มเด็ก
              และวัยรุ่น แถมยังมีบริการโต๊ะพับและเบาะที่เด็กๆ
              สามารถหยิบไปใช้เองได้หากที่นั่งไม่เพียงพออีกด้วย
            </p>
            <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border border-[#D9D9D9]">
              ศูนย์วิทยาศาสตร์พื้นฐาน อุทยานการเรียนรู้ปัตตานี เด็กๆ
              ในจังหวัดสามชายแดนภาคใต้ได้เข้าถึงสื่อการเรียนรู้วิทยาศาสตร์
              ทดลองเล่น
      ...
      >
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              กลุ่มนี้มีความต้องการในการใช้งาน ที่หลากหลาย
              ไม่ว่าจะเป็นการอ่านหนังสือ วิชาการ ทำรายงาน
              ...
              ตั้งแต่ระดับที่เงียบสงบไปจนถึงพื้นที่
              ที่อนุญาตให้ใช้เสียงได้เต็มที่
            </span>
          </div>
        </div>
            ...
            <div className="flex md:flex-row flex-col">
              <div>
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border border-[#D9D9D9]">
                  ...
                  และได้โอกาสสร้างมนุษยสัมพันธ์ กับผู้อื่น
                </p>
              </div>
              <div>
                <p className="font-th desktop-s6-th-700 text-white py-1 px-2.5 bg-tk-red w-fit">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-y border-r border-[#D9D9D9]">
                  ...
                  เดิมทีห้องสมุดนี้เป็นห้องสมุด ดนตรีเดิมอยู่แล้ว แต่ปรับปรุง
                  กระจกเงาให้ใหญ่ขึ้นจนเหมือนห้องซ้อมเต้น ใครอยากมาฝึก
                  เต้นคัฟเวอร์ เต้นลีลาศเพื่อสุขภาพ
        ...
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              ประชุมงานออนไลน์ ฝึกทักษะบางอย่าง หรือแค่มานั่งอ่านหนังสือเฉยๆ
              รอรับบุตรหลาน พูดคุยสัพเพเหระ
              ซึ่งโดยมากแล้วจะมาแช่ตัวอยู่ในพื้นที่ค่อน ข้างนานและต่อเนื่อง
          ...
          <div className="flex w-full flex-col border-2 border-white bg-yellow-100 px-10 py-5">
            <div className="flex md:flex-row flex-col">
              <div className="flex-1">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border border-[#D9D9D9]">
                  พื้นที่นั่งทำงานเป็นพื้นที่ ที่ดูพื้นฐานที่สุด แต่ต้องอาศัย
                  ความละเอียดในการออกแบบ เพราะปัจจุบันพฤติกรรมใน
                  การทำงานนอกสถานที่ของ ผู้ใช้บริการเติบโตไปตามยุคสมัย เช่น
                  บางกลุ่มอาจพก คอมพิวเตอร์ของตัวเองมา ดังนั้นแทนที่จะจัดเตรียม
                  อุปกรณ์อิเล็กทรอนิกส์ไว้บริการ หน่วยงานควรจัดพื้นที่
                  และบรรยากาศให้เหมาะสมมากกว่า ตั้งแต่บรรยากาศสบายๆ
                  แบบห้องสมุดมีชีวิต ไปจนถึงห้องเงียบ
                  ซึ่งเป็นพื้นที่ทำงานจริงจัง ของผู้ที่ต้องการความสงบ
                  และใช้สมาธิในการทำงาน หรือการอ่านอย่างเต็มที่
                </p>
              </div>
              <div className="flex-1">
                <p className="font-th desktop-s6-th-700 text-white py-1 px-2.5 bg-tk-red w-fit">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-y border-r border-[#D9D9D9]">
                  โครงการนี้เกิดจากการแก้ปัญหา ของวิถีชีวิตของคนระยอง
                  เพราะที่นี่มีนิคมอุตสาหกรรม และพนักงานจำนวนมาก และทำงานเป็นกะ
                  ดังนั้นจึงไม่สะดวกที่จะเดินทาง เข้าห้องสมุดในเวลาทำการ
                  โครงการหนังสือมือถือ จึงเป็นโครงการที่นำหนังสือ
                  เดินทางไปสู่มือของคนทำงาน อย่างทั่วถึงมากขึ้นผ่านการยืม-คืน
                  โดยห้องสมุดจะจัดกล่องหนังสือไปตั้งไว้ที่บริษัท ครั้งละ 30-60
                  เล่ม/2 เดือน
                </p>
              </div>
            </div>
        ...
        <div className="flex items-start md:flex-row flex-col">
          ...
          <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-5">
            <span className="font-th desktop-s6-th-400 text-tk-black text-balance">
              ...
              พวกเขามักจะมาใช้บริการในช่วงสายจนถึง
              เที่ยงในช่วงวันธรรมดาและวันหยุด
              เราอาจจะเห็นคุณตาคุณยายที่ชอบอ่านหนังสือพิมพ์ นิตยสาร
              หรือทำกิจกรรมเพื่อฝึกทักษะ เช่น เล่นหมากกระดาน เต้นรำ
            </span>
          </div>
        </div>
            ...
            <div className="flex md:flex-row flex-col">
              <div className="flex-1">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border border-[#D9D9D9]">
                  ...
                  เพื่อชีวิตประจำวันหรือกิจกรรมยามว่าง
                  ที่ใช้วิธีการสอนผ่านไลน์กลุ่ม
                </p>
              </div>
              <div className="flex-1">
                <p className="font-th desktop-s6-th-700 text-white py-1 px-2.5 bg-tk-red w-fit">
                ...
                <p className="font-th desktop-s6-th-400 text-tk-black py-2.5 px-3.5 bg-yellow-700 border-y border-r border-[#D9D9D9]">
                  กิจกรรมส่งเสริมการเรียนรู้ของ ผู้สูงอายุ ศูนย์การเรียนรู้
                  ฉะเชิงเทรา ผู้สูงวัยจะได้ทั้ง เรียนรู้และเสริมสุขภาพ เช่น
                  เต้นลีลาศ KCC สูงวัยโอเกะ หรือโรงเรียนผู้สูงอายุ
                </p>
              </div>
            </div>
          </div>
