    ...
    <div className="flex w-full max-w-[600px] flex-col items-center justify-center gap-50">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-2.5 p-10 border-2 border-white bg-[#FEE6A6]">
        ...
        <p className="font-th desktop-s6-th-400 text-tk-black">
          ...
          และสามารถส่งต่อความรู้ไปสู่มือคนท้องถิ่น
          ขับเคลื่อนห้องสมุดของพวกเขาให้มีความหลากหลายและตอบสนองการใช้งานของกลุ่มเป้าหมาย
        </p>
        <p className="font-th desktop-s6-th-400 text-tk-black">
      ...
      <div className="flex items-start h-full" id="subsubtopic18">
        ...
        <div className="p-10 border-2 border-white bg-orange-300 flex flex-col gap-2.5">
          ...
          <span className="font-th desktop-s6-th-400 text-tk-black">
            ...
            กล้าเข้าหา มีมนุษยสัมพันธ์ดี ใจรักงานบริการต่อกลุ่มคนหลากหลาย
            ที่เข้ามาใช้งานห้องสมุด
          </span>
        </div>
      </div>
        ...
        <div className="p-10 border-2 border-white bg-orange-50 flex flex-col">
          <div className="flex gap-2.5 px-[14px] py-2.5">
            ...
            <span className="font-th desktop-s6-th-400 text-tk-black">
              ...
              <br />
              เจ้าหน้าที่ต้องทดลองใช้งานทั้งระบบและพื้นที่ในฐานะเจ้าหน้าที่และผู้ใช้บริการ
              เมื่อเจอปัญหาในการใช้งาน
              พวกเขาต้องปรับรูปแบบการให้บริการอย่างทันท่วงที เช่น
          ...
          <div className="w-full flex flex-col items-end justify-end">
            <div className="flex flex-col max-w-[422px] items-end justify-end">
              ...
              <div className="px-[14px] py-2.5">
                <span className="font-th desktop-s6-th-400 text-tk-black">
                  ...
                  ลองระดมสมองในกลุ่มทีมเจ้าหน้าที่ หาไอเดียใหม่ๆ
                  ในการปรับเปลี่ยนพื้นที่
                </span>
              </div>
              <div className="px-[14px] py-2.5">
                <span className="font-th desktop-s6-th-400 text-tk-black">
