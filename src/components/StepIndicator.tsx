...
const SHAPE_STEP_LABELS = [
  "ก้าวแรกสู่ห้องสมุดมีชีวิต",
  "แนวคิดห้องสมุดมีชีวิต",
  "รูปแบบของการเข้าร่วม",
  "สิทธิประโยชน์ของเครือข่าย",
  "แนวทางการบริหารจัดการพื้นที่เรียนรู้",
  "หลักการออกแบบพื้นที่",
  "ตัวอย่างสร้างแรงบันดาลใจ",
  "แนวทางการจัดสรรงบประมาณ",
  "นโยบายและข้อตกลงการใช้พื้นที่",
  "หลักการบริหารบุคลากร",
  "รูปแบบบริการตามกลุ่มเป้าหมาย",
  "แนะนำกิจกรรม",
  "ตัวอย่างพื้นที่การเรียนรู้",
] as const;
